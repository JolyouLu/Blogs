...
![在这里插入图片描述](./images/70-16859298603163.png)

#### ByteBuffer获取只读

![在这里插入图片描述](./images/70-16859298960826.png)

#### ByteBuffer类型化操作

ByteBuffer可以按类型put不过再读取时也要使用相同类型get否则可能会出现异常，或者获取的数据于写入数据不一致

![在这里插入图片描述](./images/70-168592991514310.png)
...
![在这里插入图片描述](./images/20200920142635826.png)



#### 把字符串写入到文件

![在这里插入图片描述](./images/70-168592993719314.png)



#### 读取文件输出到控制台

![在这里插入图片描述](./images/70-168592995071018.png)



#### 使用缓冲区拷贝文件

![在这里插入图片描述](./images/70-168592997204422.png)



#### 直接通过通道拷贝文件

![在这里插入图片描述](./images/70-168592998714326.png)
...
![在这里插入图片描述](./images/70-168593000110030.png)
